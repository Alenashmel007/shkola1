...
namespace SchoolSystem.Common //AllocationRequest
{
        ...
        public void CreateReport(string nameTitle, DataGridView grid)
        {
            if (grid.Rows.Count > 0)
            {
                DGVPrinter printer = new()
                {
                    ...
                    SubTitleFont = new Font("Arial", 12, FontStyle.Italic),
                    FooterFont = new Font("Arial", 10, FontStyle.Italic),
                    HeaderCellAlignment = StringAlignment.Near,
                    Footer = "Актуально на: " + DateTime.Now.ToString("dd.MMM, HH:mm"),
                    FooterSpacing = 100,
            ...
            {
                MessageBox.Show("Данные для экспорта не обнаружены", "Уведомление", MessageBoxButtons.OK, MessageBoxIcon.Warning);
            }
        }
